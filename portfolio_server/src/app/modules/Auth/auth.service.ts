  ...
  await emailSender(
    ...
    `
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <img src="https://your-logo-url.com/logo.png" alt="Landing Portfolio" style="max-width: 100px;"/>
        </div>
        <div style="text-align: left; padding: 10px 20px;">
            <h2 style="color: #333;">Password Reset Request</h2>
            <p style="color: #555;">Dear User,</p>
            <p style="color: #555;">You recently requested to reset your password for your Landing Portfolio account. Click the button below to reset it.</p>
            ...
            <p style="color: #555;">Thank you,<br/>The Landing Portfolio Team</p>
        </div>
        <div style="text-align: center; margin-top: 20px; font-size: 12px; color: #999;">
            <p>&copy; ${new Date().getFullYear()} Landing Portfolio. All rights reserved.</p>
        </div>
    </div>
        `
  );
